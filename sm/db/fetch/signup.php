<main data-url="signup" data-title="Signup" class="center">
    <form action="" method="post">
        ...
        <input type="password" placeholder="Confirm Password" maxlength="1000" autocomplete="new-password">
        <button data-f="Lb" class="btn">Sign Up</button>
        <div>Already have an account?&nbsp;<button data-f="_$" data-n="login" class="a">Log In</button></div>
    </form>
</main>
